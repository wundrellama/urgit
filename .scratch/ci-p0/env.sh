#!/bin/bash
# Harness environment for the P1 chair `opus` ship (~ryp, launch footer of
# BRIEF-CI-P1.md). Source this from every script. Nothing secret lives here:
...
export SHIP=ryp
export PORT=8346
export PIER=/var/home/michael/piers/urgit-ci-p1-ryp
