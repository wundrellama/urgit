#!/bin/bash
# Harness environment for the P2 ship (~dep:8353, launch footer of
# BRIEF-CI-P2.md; the P1 close-out ran on ~peg:8350, the P1 build on
# ~ryp:8346). Source this from every script. Nothing secret lives here:
