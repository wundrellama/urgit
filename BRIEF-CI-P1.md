...
- Worktree: `/var/home/michael/workspace/urbit/urgit-ci-p1-opus` — branch `ci/p1-opus`, base `abc82ab` (= `master`, re-frozen).
...
- Planted, untracked, read-only: `REFERENCE-CI-RULINGS.md` (now carries CI-LAND-1, CI-BASELINE-P1, CI-EXPR-1, CI-TRUST-P1), `.scratch/act-list-erpit.txt`, `.scratch/spike-001a-act-README.md`.
