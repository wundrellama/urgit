...
- Worktree: `/var/home/michael/workspace/urbit/urgit-ci-p1-opus` — branch `ci/p1-opus`, base `ef8c3eb` (= `master`, re-frozen 4).
...
- Planted, untracked, read-only: `REFERENCE-CI-RULINGS.md` (carries CI-LAND-1, CI-BASELINE-P1, CI-EXPR-1, CI-TRUST-P1, CI-LINKED-DESK-P1-B, CI-PROJECT-1-A, CI-PROJECT-1.1), `.scratch/act-list-erpit.txt`, `.scratch/spike-001a-act-README.md`.
